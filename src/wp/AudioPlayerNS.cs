...
namespace WPCordovaClassLib.Cordova.Commands
{
    ...
    /// </summary>
    internal class AudioPlayerNS : IDisposable
    {
        #region Constants
        ...
        /// <summary>
        /// The id of this player (used to identify MediaNS object in JavaScript)
        /// </summary>
        private String id;
        ...
        /// <summary>
        /// Creates AudioPlayerNS instance
        /// </summary>
        /// <param name="handler">MediaNS object</param>
        /// <param name="id">player id</param>
        public AudioPlayerNS(MediaNS handler, String id)
        {
        ...
        {
            var status = new MediaNS.MediaStatus()
            {
                Id = this.id,
                MsgType = message
            };
            ...
            {
                status.Value = new MediaNS.MediaError() { Code = (int)value };
            }
            else
            {
                status.Value = value;
        ...
        public void startPlaying(string filePath)
        {
            ...
            if (this.player == null || this.player.Source.AbsolutePath.LastIndexOf(filePath) < 0)
            {
                ...
                {
                    Debug.WriteLine("Error in AudioPlayerNS::startPlaying : " + e.Message);
        ...
        private void MediaFailed(object sender, RoutedEventArgs arg)
        {
            ...
            InvokeCallback(MediaError, MediaErrorStartingPlayback, false);
            //this.handler.InvokeCustomScript(new ScriptCallback(CallbackFunction, this.id, MediaError.ToString(), "MediaNS failed"),false);
        }
